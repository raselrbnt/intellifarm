        ...
        <main class="home main">
            <section class="smartAgricultureSection">
                ...
                >
                    ...
                    <img
                        class="showcaseImageFig"
                        src="{{ asset('assets/ccad6907c434c714f0ed0cb116db9c0f.svg') }}"
                        alt="alt text"
                    />
                    ...
                    <div class="showcaseFlexContainerDiv">
                        ...
                        <div class="showcaseRowContainerDiv">
                            ...
                            <div class="showcaseSubRowDiv">
                                ...
                                <img
                                    class="showcaseMainImageFig"
                                    src="{{ asset('assets/43fa406488b93e476db137757b3e31be.png') }}"
                                    alt="alt text"
                                ...
                                <div class="showcaseControlsDiv">
                                    ...
                                    <p
                                        class="productLabelP"
                                        onclick="window.open('{{ url('/product') }}', `_self`)"
                                    >
                                        <!-- Label for product details. -->
                                        PRODUCT
                                    </p>
                                    <p
                                        class="sustainabilityLabelP"
                                        onclick="window.open('{{ url('/sustainability') }}', `_self`)"
                                    >
                            ...
                            <div class="showcaseRowImagesDiv">
                                ...
                                <div class="contentBoxWithSearchDiv">
                                    ...
                                    <img
                                        class="searchImageFig"
                                        src="{{ asset('assets/65ef51ababa7d8ec637a5ee78663d61c.png') }}"
                                        alt="alt text"
                                    />
                                ...
                                <img
                                    class="additionalImage1Fig"
                                    src="{{ asset('assets/1e3e16227d24975d44b22e341c50035e.svg') }}"
                                    alt="alt text"
                                />
                        ...
                        <div class="showcaseRowHeaderDiv">
                            ...
                            <div class="heroTitleContainerDiv">
                                ...
                                <h1 class="heroTitleH1_box">
                                    ...
                                    <span class="heroTitleH1">
                                        <span class="heroTitleH1_span0"
                                            >SMART AGRICULTURE
                                        </span>
                                        <span class="heroTitleH1_span1"
                                            >TECHNOLOGY</span
                                        >
                                    </span>
                                </h1>
                                        ...
                                        <div class="clientsCountContainerDiv">
                                            ...
                                            <h1 class="clientsTitleH1_box">
                                                ...
                                                <span class="clientsTitleH1">
                                                    <span
                                                        class="clientsTitleH1_span0"
                                                        >OUR
                                                    </span>
                                                    <span
                                                        class="clientsTitleH1_span1"
                                                    >
                                                        15k+
                                                        <br />
                                                    </span>
                                                    <span
                                                        class="clientsTitleH1_span2"
                                                        >Clients</span
                                                    >
                                                </span>
                                            </h1>
                                            <hr
                                                class="separatorLineHR"
                                                size="1"
                                            />
                                            <button
                                                class="contactUsBtn"
                                                onclick="window.open('{{ url('/contact') }}', `_self`)"
                                            >
                                                <!-- Button to contact for more information. -->
                                                <div
                                                    class="contactUsBtnTextDiv"
                                                >
                                                    Contact Us
                                                </div>
                                                <img
                                                    class="contactUsBtnIconImg"
                            ...
                            <div class="upcomingEventsContainerDiv">
                                ...
                                <div class="eventImageContainerDiv">
                                    ...
                                    <img
                                        class="eventImageFig"
                                        src="{{ asset('assets/0605094ec1cc8446922062c12e4023df.png') }}"
                                        alt="alt text"
                                    />
                                ...
                                <div class="farmHubInfoContainerDiv">
                                    ...
                                    <button class="getTheAppBtn">
                                        ...
                                        <img
                                            class="getTheAppBtnIconImg"
                                            src="{{ asset('assets/506480ea8306935f112181e1dcc5e4a6.png') }}"
                                            alt="alt text"
                                        />
                    ...
                    <div class="flex_col1">
                        <div class="flex_row2">
                            ...
                            <div class="flex_row3">
                                <img
                                    class="featureImage1"
                                    src="{{ asset('assets/7a117eef5954fd299d6bfa8577532d92.png') }}"
                                    alt="alt text"
                                />
                                <img
                                    class="featureImage2"
                                    src="{{ asset('assets/7ee116cf54c081cb51056d7be3588e8e.png') }}"
                                    alt="alt text"
                                />
                            </div>
                        </div>
                        <div class="flex_row4">
                            ...
                            <div class="flex_row5">
                                ...
                                <div
                                    class="content_box2"
                                    style="--src: url('{{ asset('assets/Union.svg') }}')"
                                >
                                    <div class="content_box1">
                                        <div class="group">
                                            <div
                                                class="featureHighlightNum"
                                            ></div>
                    ...
                    <div class="teamOverviewColumn">
                        ...
                        <div class="teamHeaderRow">
                            ...
                            <div class="heroContentRow">
                                ...
                                <img
                                    class="teamImage"
                                    src="{{ asset('assets/43233b275bb5d90bccc0d14a9813ed42.png') }}"
                                    alt="alt text"
                                />
                                <h1 class="heroTitle">
                        ...
                        <div class="teamMemberRow">
                            ...
                            <div class="teamImagesColumn">
                                ...
                                >
                                    ...
                                    <div class="teamMembersColumn">
                                        ...
                                        <div
                                            class="individualMemberImageColumn"
                                        >
                                            <!-- Column for a team member&#x27;s image. -->
                                            <img
                                                id="mainImage"
                                                class="individualMemberImage"
                            ...
                            <div class="teamQuoteRow">
                                ...
                                <div class="quoteColumn">
                                    ...
                                    <img
                                        class="quoteImage"
                                        src="{{ asset('assets/8308732b423b578053460bbdd052c506.png') }}"
                                        alt="alt text"
                                    />
                                    <p class="quoteText">
                                    ...
                                    >
                                        ...
                                        <img
                                            class="joinButtonImage"
                                            src="{{ asset('assets/a1abb782cb16e447ba9ce7954fea1b2a.png') }}"
                                            alt="alt text"
                                            onclick="window.open('{{ url('/Career') }}', `_self`)"
                                        />
                                    </div>
            ...
            <section class="productOverviewSection">
                ...
                <div class="flexRow1">
                    ...
                    <div class="flex_row1">
                        <img
                            class="productImage1"
                            src="{{ asset('assets/eec8b7add76f850595e494037df7f050.png') }}"
                            alt="alt text"
                        />
                        <!-- Image representing the first product. -->
                        <img
                            class="productImage2"
                            src="{{ asset('assets/80bff0aecf7412c69fd52bd875ef5e31.png') }}"
                            alt="alt text"
                        />
                    ...
                    <div class="flex-col">
                        <div class="flexRow3">
                            ...
                            <div class="flexRow5">
                                ...
                                <img
                                    class="image28"
                                    src="{{ asset('assets/d8c3ab07ca06eb446f4c4e6f1a99ffda.png') }}"
                                    alt="alt text"
                                />
                            </div>
                        </div>
                        <div class="flexRow6">
                            ...
                            <div class="contentBox1">
                                ...
                                <div class="flexRow7">
                                    ...
                                    <img
                                        class="productImage3"
                                        src="{{ asset('assets/bca69fdc89bac0d8bfbce80d0d7e52b4.png') }}"
                                        alt="alt text"
                                    />
                                    <!-- Image representing another product. -->
                                    <img
                                        class="productImage4"
                                        src="{{ asset('assets/7e94f69f337b4b674f0a3d82ed71ece6.png') }}"
                                        alt="alt text"
                                    />
                                    <!-- Image representing another product. -->
                                    <img
                ...
                <div class="flexContainerCol">
                        ...
                        <div class="flexContainerCol2">
                            ...
                            <div class="flexContainerCol3">
                                ...
                                <div class="flexContainerRow">
                                    <img
                                        class="trustedCompanyLogo1"
                                        src="{{ asset('assets/fe91d9425af2d7895d0b688241db37ff.png') }}"
                                        alt="alt text"
                                    />
                                    <img
                                        class="trustedCompanyLogo2"
                                        src="{{ asset('assets/623bcab14d80e5723575ee1efc5a0f09.png') }}"
                                        alt="alt text"
                                    />
                                    <img
                                        class="trustedCompanyLogo3"
                                        src="{{ asset('assets/66b9dca326f4a70ab787c36284073a9a.png') }}"
                                        alt="alt text"
                                    />
                                    <img
                                        class="trustedCompanyLogo4"
                                        src="{{ asset('assets/f7770fae54be05492c19b543d37f34d1.png') }}"
                                        alt="alt text"
                                    />
                                    <img
                                        class="trustedCompanyLogo5"
                                        src="{{ asset('assets/6c75dbf832009c90d2804e1108745a47.png') }}"
                                        alt="alt text"
                                    />
                                </div>
                            </div>
                    ...
                    <h3 class="assistanceSubtitle_box">
                        <span class="assistanceSubtitle">
                            <span class="assistanceSubtitle_span0"
                                >Got questions or need assistance?
                            </span>
                            <span class="assistanceSubtitle_span1"
                                >Contact us</span
                            >

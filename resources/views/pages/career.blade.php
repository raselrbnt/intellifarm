        ...
        <section class="joinUsSection">
            ...
            <div class="flexColumnLayout">
                ...
                <div class="contentGroup">
                    ...
                    <img class="rectangleShape" src="{{ asset('assets/1b7bd5c816aff8bfd86437e5a46f57b6.png') }}"
                        alt="alt text" />
                    <img class="additionalRectangle" src="{{ asset('assets/1b7bd5c816aff8bfd86437e5a46f57b6.png') }}"
                        alt="alt text" />
                    <img class="heroImage" src="{{ asset('assets/bfae5ba73837261be40b2d000bf70173.png') }}"
                        alt="alt text" />
                ...
                <div class="contentColumnContainer">
                    ...
                    <div class="leftColumn">
                        ...
                        <div class="rowInnerContainer">
                            ...
                            <img class="leadingTechnologyImage"

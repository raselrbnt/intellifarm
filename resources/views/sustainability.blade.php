...
<html>
    <head>
        ...
        <title>FarmHUB-Sustainability</title>
        <link
            rel="stylesheet"
            type="text/css"
        ...
        <main class="sustainability main">
                    ...
                    <div class="flexRowBottom">
                        ...
                        <div class="contentBoxContainer">
                            ...
                            <div class="contentBox">
                                ...
                                <img
                                    class="searchIconImg"
                                    src="{{ asset('assets/6b38b525dbbc2d0e3c79a02e480e2e96.png') }}"
                                    alt="alt text"
                                />
                            </div>
                        ...
                        <img
                            ...
                            src="{{ asset('assets/302958ef4a6811348969a2badbfad7ac.svg') }}"
                            alt="alt text"
                        />
                    </div>
                </div>
            ...
            <section class="environmentalSustainabilitySection">
                ...
                <div class="flexColumn">
                    ...
                    <div
                        class="contentBoxPrimary"
                        style="--src: url('{{ asset('assets/5f29fe4a122b21f34183e53b2012c781.png') }}');"
                    >
                        <!-- Primary content box containing sustainability commitment information. -->
                        <div
                            class="rect15"
                            style="--src: url('{{ asset('assets/a065da1de18f5a8a990fb39609f1b0f8.png') }}');"
                        ></div>
                        <div class="flex_row">
                            <div
                                class="content_box5"
                                    ...
                                    <div class="flex_col">
                                        <div class="flexColumnTwo">
                                            ...
                                            <div class="flexColumnThree">
                                                ...
                                                <h1
                                                    class="environmentalCommitmentTitle"
                                                >
                                    ...
                                    <div class="group">
                                        <div class="flex_row1">
                                            <div class="flex_col1">
                                                <div class="flex_col2">
                                                    <h1
                                                        class="sustainabilityStatsTitle"
                                                    >
                                                        <!-- Title showing a sustainability metric, such as &#x27;1k+&#x27;. -->
                                                        1k+
                                                    </h1>
                                                    <img
                                                        class="sustainabilityImageOne"
                                                ...
                                                <div class="flex_col3">
                                                    <h1
                                                        class="sustainabilityImpactTitle"
                                                    >
                                                        <!-- Title showing a sustainability impact metric, such as &#x27;25%&#x27;. -->
                                                        25%
                                                    </h1>
                                                    <img
                                                        class="sustainabilityPercentImage"
                                            ...
                                            <div class="flex_col4">
                                                <div class="flex_col5">
                                                    ...
                                                    <img
                                                        class="sustainabilityImageDetail"
                                                        src="{{ asset('assets/a56da99d18c09fcb2817da9c43993496.png') }}"
                                                        alt="alt text"
                                                    />
                                                ...
                                                <img
                                                    class="image1"
                                                    src="{{ asset('assets/ca2f5da24167cf8062f651d0886f8ffa.png') }}"
                                                    alt="alt text"
                                                />
                                            </div>
                                        </div>
                                        <img
                                            class="coverImage"
                                            src="{{ asset('assets/4a50a5b39bbc0c1ae337deb5bcb46e9d.png') }}"
                                            alt="alt text"
                                        />
                            ...
                            <div class="flexRowTwo">
                                ...
                                <div class="flex_col6">
                                    <div class="contentBoxSecondary">
                                        ...
                                        <div class="flex_col7">
                                            ...
                                            <p
                                                class="natureFutureHighlightText"
                                            >
                                ...
                                <div class="flex_row2">
                                    ...
                                    <div class="flex_col8">
                                        <img
                                            class="image26"
                                            src="{{ asset('assets/7a7f99df1f506cca6236deb6434aefb3.png') }}"
                                            alt="alt text"
                                        />
                                        <img
                                            class="image25"
                                            src="{{ asset('assets/3a14bffd72d1443f136fc3d33273f4b2.png') }}"
                                            alt="alt text"
                                        />
                                    </div>
                                </div>
            ...
            <section class="sustainabilityImpactSection">
                ...
                <div class="flexRowDiv">
                    ...
                    <img
                        class="waterUsageImage"
                        src="{{ asset('assets/1c123d2a887eeea3610c8a84972c321d.png') }}"
                        alt="alt text"
                    />
                        ...
                        <div class="waterUsageGroup">
                            ...
                            <h2 class="waterUsageTitle_box">
                                ...
                                <span class="waterUsageTitle">
                                    ...
                                    <span class="waterUsageTitle_span1"
                                        ><br
                                    /></span>
                                    <span class="waterUsageTitle_span2"
                                        >Our irrigation technology has reduced
                                        water usage by up to
                                    </span>
                                    <span class="waterUsageTitle_span3"
                                        >30%</span
                                    >
                            ...
                            <img
                                class="image36"
                                src="{{ asset('assets/bacfc4d1c6cf66b7b8234c0f1ca07a9c.png') }}"
                                alt="alt text"
                            />
                        </div>
                        <div class="fertilizerEfficiencyGroup">
                            ...
                            <h2 class="fertilizerEfficiencyTitle_box">
                                ...
                                <span class="fertilizerEfficiencyTitle">
                                    <span
                                        class="fertilizerEfficiencyTitle_span0"
                                    >
                                        Fertilizer Efficiency
                                        <br />
                                    </span>
                                    <span
                                        class="fertilizerEfficiencyTitle_span1"
                                        ><br
                                    /></span>
                                    <span
                                        class="fertilizerEfficiencyTitle_span2"
                                        >Targeted fertilizer use through data
                                        analysis has reduced fertilizer usage by
                                        up to
                                    </span>
                                    <span
                                        class="fertilizerEfficiencyTitle_span3"
                                        >25%.</span
                                    >
                                </span>
                            </h2>
                            <img
                                class="image38"
                                src="{{ asset('assets/e41e2d1adb90d3b1047fc61969b6e1c4.png') }}"
                                alt="alt text"
                            />
                        </div>
                        <div class="trainingGroup">
                            ...
                            <h2 class="farmerTrainingTitle_box">
                                ...
                                <span class="farmerTrainingTitle">
                                    ...
                                    <span class="farmerTrainingTitle_span1"
                                        ><br
                                    /></span>
                                    <span class="farmerTrainingTitle_span2"
                                        >Over
                                    </span>
                                    <span class="farmerTrainingTitle_span3"
                                        >1,000</span
                                    >
                            ...
                            <img
                                class="image37"
                                src="{{ asset('assets/3520f780246f5bc23b8038bb025ededa.png') }}"
                                alt="alt text"
                            />
                        </div>
                    </div>
                ...
                <div class="flexRowPrimary">
                    ...
                    <div class="flexRowImageContent">
                        ...
                        <div class="imageGroup">
                            ...
                            <img
                                class="researchImage2024"
                                src="{{ asset('assets/e551142b73876f8d0a2d16ab4ad78afe.png') }}"
                                alt="alt text"
                            />
                            <!-- Image representing research for 2024. -->
                            <div
                                class="contentBoxResearch2024"
                        ...
                        <img
                            class="additionalResearchImage"
                            src="{{ asset('assets/63e54440b760ce731cf02d62d7a83c75.png') }}"
                            alt="alt text"
                        />
